			...
			<v-layout class="mb-3">
				<v-card style="width: 100%">
					<v-layout class="mt-3 mx-3" column>
						<v-flex class="mb-4" raw><h3 class="ml-2">Словарные выражения</h3></v-flex>
					</v-layout>
					...
					<dictionary-table ref="table" :id.sync="dict_id" is-have="false" :search.sync="search"></dictionary-table>
...
<script>
    ...
    export default {
        ...
        created() {
            this.dict_id = this.$route.params.id;
        },
