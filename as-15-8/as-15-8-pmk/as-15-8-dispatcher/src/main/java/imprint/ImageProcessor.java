...
public class ImageProcessor {
	 ...
	 *
	 * @param	fontInputStream name of the font inputStream with path
	 */
	...
	private BufferedImage getGluedCopy(BufferedImage originalImage, BufferedImage headerImage, boolean preserveAlpha) {
		...
		g.drawImage(originalImage, 0, headerImage.getHeight(), originalImage.getWidth(), originalImage.getHeight(), null);
